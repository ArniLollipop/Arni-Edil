<template>
  <div class = "flex items-center justify-center min-h-[100vh] bg-pink sm:bg-transparent">
    <section class = "2xl:w-[1400px] 2xl:mx-auto mx-auto px-4 py-4 text-dark sm:bg-transparent h-fit bg-pink">
      ...
      <div class = "xl:mt-40 lg:mt-32 sm:mt-16 mt-8  xl:px-40 lg:px-32 md:px-20  ">
        <div class = "sm:bg-pink pt-14 rounded-[10px] sm:border border-gray sm:mx-0 sm:w-full w-fit mx-auto block" >
          <div class = "flex w-full justify-between relative overflow-hidden">
            ...
            <div class = "xl:w-[40%] w-full pb-6 sm:px-6 sm:pr-10">
              <div class = "flex justify-between">
                <button class = "py-2 md:w-36 sm:w-32 w-[120px] bg-white border border-gray rounded-[10px] shadow-md shadow-accent">
                  <p class = "text-sm text-center">Увійти</p>
                </button>
                <router-link to="/sign" class = "py-2 md:w-36 sm:w-32 w-[120px] bg-white border border-gray rounded-[10px]">
                  <p class = "text-sm text-center">Реєстрація</p>
                </router-link>
              </div>
              ...
              <p class = "text-[10px] text-red my-1">Невірний логін та/або пароль!</p>
              <router-link to="/login_error" class = "w-[180px] py-2 bg-accent rounded-full block mx-auto mt-6"><p class = "text-white text-sm font-medium text-center">Увійти</p></router-link>
              <button class = "w-[180px] py-2 bg-white rounded-full block mx-auto mt-3 border border-gray"><p class = "text-dark text-sm">Відновити пароль</p></button>
              <p class = "text-xs mt-5 text-center">або через соцмережу </p>
              <button class = "w-[150px] py-2 border border-accent border-opacity-80 bg-white rounded-full mx-auto mt-3 flex items-center justify-between px-7">
                <img src="@/img/google_icon.svg" alt="">
