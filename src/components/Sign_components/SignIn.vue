          ...
          <div class = "flex w-full justify-between relative overflow-hidden">
            ...
            <div class = "xl:w-[40%] w-full pb-6 sm:px-6 sm:pr-10">
              ...
              <div class = "-translate-y-10">
                <button class = "w-[180px] py-2 bg-accent rounded-full block mx-auto lg:mt-32 md:mt-16 mt-16"><p class = "text-white text-sm font-medium text-center">Продовжити</p></button>
