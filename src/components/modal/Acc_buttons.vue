<template>
  <div class = "w-[100%] rounded-[10px] py-2 px-4 bg-white h-fit ">
    ...
    <router-link to="/account">
      <button class = "w-[95%] mt-4 mx-auto flex items-center space-x-4 px-4 rounded-[10px] border border-accent py-2 hover:shadow-sm hover:shadow-accent">
        <img src="@/img/person_acc1.svg" alt="" class = "w-[15px]">
        <p class = "text-xs">Акаунт [Базовий]</p>
      </button>
    </router-link>
    <router-link to="/account">
      <button class = "w-[95%] mt-2 mx-auto flex items-center space-x-4 px-4 rounded-[10px] border border-accent py-2 hover:shadow-sm hover:shadow-accent">
        <img src="@/img/moi_acc.svg" alt="" class = "w-[15px]">
        <p class = "text-xs">Мої оголошення</p>
      </button>
    </router-link>
    <router-link to="/orders">
      <button class = "w-[95%] mt-2 mx-auto flex items-center space-x-4 px-4 rounded-[10px] border border-accent py-2 hover:shadow-sm hover:shadow-accent">
        <img src="@/img/acc_zamovleni.svg" alt="" class = "w-[15px]">
    ...
    <router-link to="/account">
      <button class = "w-[95%] mt-2 mx-auto flex items-center space-x-4 px-4 rounded-[10px] border border-accent py-2 hover:shadow-sm hover:shadow-accent">
        <img src="@/img/acc_leave.svg" alt="" class = "w-[15px]">
        <p class = "text-xs">Вихід</p>
      </button>
    </router-link>
  </div>
</template>
