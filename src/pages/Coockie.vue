    ...
    >
      <div class="lg:flex gap-x-5 relative">
        ...
        >
          ...
          >
            Політика використання файлів cookie сайту Vamberi
          </h1>
          <router-link to="/blog">
        ...
        <div class="lg:w-[85%] w-full lg:pt-2">
          <h1
            class="lg:text-3xl md:text-[20px] sm:text-base text-sm font-medium text-center lg:text-start lg:relative absolute top-0 lg:mb-5 mb-2 h-fit lg:block hidden"
          >
            Політика використання файлів cookie сайту Vamberi
          </h1>
          <div class="md:text-sm text-xs w-[94%] relative">
            ...
            <p>
              Наш сайт використовує файли cookie та схожі технології, щоб
              гарантувати максимальну зручність користувачам, надаючи
              персональну інформацію, запам'ятовуючи переваги в галузі
              маркетингу та продукції, а також допомагаючи отримати правильну
              інформацію.
            </p>
            <p>
              При використанні цього сайту, ви підтверджуєте свою згоду на
              використання файлів cookie відповідно до цього повідомлення щодо
              цього типу файлів.
            </p>
            <p>
              Якщо ви не згодні з тим, щоб ми використовували цей тип файлів, ви
              повинні відповідним чином встановити налаштування вашого браузера
              або не використовувати цей сайт.
            </p>
          </div>
        </div>
      </div>
