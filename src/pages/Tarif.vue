  ...
  <section class = "container mx-auto px-4 pt-4 xl:pt-6 text-main">
    ...
    <div class = "lg:flex lg:space-x-10 mb-4">
      ...
      <div class = "lg:w-[75%] w-full relative">
        <div class = "w-full rounded-[10px] px-3 pt-4 pb-2 bg-banner text-main flex justify-between relative">
          <div class = "w-[65%]">
            ...
            <div class = "sm:grid grid-cols-3 hidden gap-x-10">
              <div class = "bg-white h-fit py-4 px-4 rounded-[10px] border border-accent">
                <div class = "border-b border-gray pb-4 border-opacity-60">
                  <p class = "text-xl font-medium">Магазин - Тестовий</p>
                  <p class = "my-1 text-base"><span class = "font-medium">Безкоштовно</span> на 3 дня</p>
                  <p class = "text-base">Протестуйте тариф з усім функціоналом протягом дня</p>
                </div>
                <div class = "mt-2"> 
                  <div class = "flex space-x-3">
                    <img src="@/img/tarif_galochka.svg" alt="" >
                    <p class = "lg:text-base text-sm">Персональний магазин</p>
                  </div>
                  <div class = "flex space-x-3">
                    <img src="@/img/tarif_galochka.svg" alt="" >
                    <p class = "lg:text-base text-sm">Додаткові сторінки у магазині</p>
                  </div>
                  <div class = "flex space-x-3">
                    <img src="@/img/tarif_galochka.svg" alt="" >
                    <p class = "lg:text-base text-sm">Унікальна адреса магазину</p>
                  </div>
                  <div class = "flex space-x-3">
                    <img src="@/img/tarif_galochka.svg" alt="" >
                    <p class = "lg:text-base text-sm">Пошук у магазині тільки про ваші товари</p>
                  </div>
                  <div class = "flex space-x-3">
                    <img src="@/img/tarif_galochka.svg" alt="" >
                    <p class = "lg:text-base text-sm">Приховування конкурентів у ваших оголошеннях</p>
                  </div>
                  <div class = "flex space-x-3">
                    <img src="@/img/tarif_galochka.svg" alt="" >
                    <p class = "lg:text-base text-sm">Розширена статистика</p>
                  </div>
                  <div class = "flex space-x-3">
                    <img src="@/img/tarif_galochka.svg" alt="" >
                    <p class = "lg:text-base text-sm">Планувальник завдань</p>
                  </div>
                </div>
              </div>
              <div class = "bg-white h-fit py-4 px-4 rounded-[10px] border border-accent">
                <div class = "border-b border-gray pb-4 border-opacity-60">
                  <p class = "text-xl font-medium">Магазин - Преміум</p>
                  <p class = "my-1 text-base">10 грн. <span class = "text-red line-through"> 99 грн.</span> за 60 днів</p>
                  <p class = "text-base">Базовий тариф із початковим функціоналом</p>
                </div>
                <div class = "mt-2"> 
                  <div class = "flex space-x-3">
                    <p class = "lg:text-base text-sm text-accent">+</p>
                    <p class = "lg:text-base text-sm">29 грн. на бонусний рахунок </p>
                  </div>
                  <div class = "flex space-x-3">
                    <img src="@/img/tarif_galochka.svg" alt="" >
                    <p class = "lg:text-base text-sm">Персональний магазин</p>
              ...
              <div class = "bg-white h-fit py-4 px-4 rounded-[10px] border border-accent">
                <div class = "border-b border-gray pb-4 border-opacity-60">
                  <p class = "text-xl font-medium">Магазин - Максимум</p>
                  <p class = "my-1 text-base">10 грн. <span class = "text-red line-through">  199 грн.</span> за 60 днів</p>
                  <p class = "text-base">Максимальний тариф  функціоналом</p>
                </div>
                <div class = "mt-2"> 
                  <div class = "flex space-x-3">
                    <p class = "lg:text-base text-sm text-accent">+</p>
                    <p class = "lg:text-base text-sm">49 грн. на бонусний рахунок </p>
                  </div>
                  <div class = "flex space-x-3">
                    <img src="@/img/tarif_galochka.svg" alt="" >
                    <p class = "lg:text-base text-sm">Персональний магазин</p>
              ...
              <swiper 
                ...
                <swiper-slide class = "bg-white h-fit py-4 px-4 rounded-[10px] border border-accent">
                  <div class = "border-b border-gray pb-4 border-opacity-60">
                    ...
                    <p class = "my-1 text-xs"><span class = "font-medium">Безкоштовно</span> на 3 дня</p>
                    <p class = "text-xs">Протестуйте тариф з усім функціоналом протягом дня</p>
                  </div>
                  <div class = "mt-2"> 
                    <div class = "flex space-x-3">
                      <img src="@/img/tarif_galochka.svg" alt="" >
                      <p class = "text-xs">Персональний магазин</p>
                    </div>
                    <div class = "flex space-x-3">
                      <img src="@/img/tarif_galochka.svg" alt="" >
                      <p class = "text-xs">Додаткові сторінки у магазині</p>
                    </div>
                    <div class = "flex space-x-3">
                      <img src="@/img/tarif_galochka.svg" alt="" >
                      <p class = "text-xs">Унікальна адреса магазину</p>
                    </div>
                    <div class = "flex space-x-3">
                      <img src="@/img/tarif_galochka.svg" alt="" >
                      <p class = "text-xs">Пошук у магазині тільки про ваші товари</p>
                    </div>
                    <div class = "flex space-x-3">
                      <img src="@/img/tarif_galochka.svg" alt="" >
                      <p class = "text-xs">Приховування конкурентів у ваших оголошеннях</p>
                    </div>
                    <div class = "flex space-x-3">
                      <img src="@/img/tarif_galochka.svg" alt="" >
                      <p class = "text-xs">Розширена статистика</p>
                    </div>
                    <div class = "flex space-x-3">
                      <img src="@/img/tarif_galochka.svg" alt="" >
                      <p class = "text-xs">Планувальник завдань</p>
                    </div>
                  </div>
                </swiper-slide>
                <swiper-slide class = "bg-white h-fit py-4 px-4 rounded-[10px] border border-accent">
                  <div class = "border-b border-gray pb-4 border-opacity-60">
                    <p class = "text-sm font-medium">Магазин - Преміум</p>
                    <p class = "my-1 text-xs">10 грн. <span class = "text-red line-through"> 99 грн.</span> за 60 днів</p>
                    <p class = "text-xs">Базовий тариф із початковим функціоналом</p>
                  </div>
                  <div class = "mt-2"> 
                    <div class = "flex space-x-3">
                      <p class = "lg:text-base text-sm text-accent">+</p>
                      <p class = "text-xs">29 грн. на бонусний рахунок </p>
                    </div>
                    <div class = "flex space-x-3">
                      <img src="@/img/tarif_galochka.svg" alt="" >
                      <p class = "text-xs">Персональний магазин</p>
                ...
                <swiper-slide class = "bg-white h-fit py-4 px-4 rounded-[10px] border border-accent">
                  <div class = "border-b border-gray pb-4 border-opacity-60">
                    <p class = "text-sm font-medium">Магазин - Максимум</p>
                    <p class = "my-1 text-xs">10 грн. <span class = "text-red line-through">  199 грн.</span> за 60 днів</p>
                    <p class = "text-xs">Максимальний тариф  функціоналом</p>
                  </div>
                  <div class = "mt-2"> 
                    <div class = "flex space-x-3">
                      <p class = "lg:text-base text-sm text-accent">+</p>
                      <p class = "text-xs">49 грн. на бонусний рахунок </p>
                    </div>
                    <div class = "flex space-x-3">
                      <img src="@/img/tarif_galochka.svg" alt="" >
                      <p class = "text-xs">Персональний магазин</p>
