  ...
  <section class="2xl:w-[1400px] 2xl:mx-auto mx-auto px-4 py-4 text-dark">
    ...
    >
      ...
      <div class="sm:grid grid-cols-1 md:pt-10 sm:pt-5 gap-y-6">
        <div
          class="sm:bg-white bg-transparent w-full sm:px-5 sm:py-5 rounded-[10px] min-h-[260px]"
          v-for="text in texts"
        >
          <div
            class="w-full h-full sm:grid sm:grid-cols-5 relative sm:gap-x-6 pb-20 md:pb-0 block"
          >
            <div
              class="lg:col-span-1 sm:col-span-2 overflow-hidden sm:pt-0 pt-11"
            >
              <img
                :src="require('../img/' + text.img)"
                alt=""
                class="w-full sm:h-full sm:min-h-[190px] h-[160px] rounded-[10px]"
              />
            </div>
            <div class="lg:col-span-4 sm:col-span-3 md:relative">
              ...
              <div class="absolute left-0 sm:bottom-0 -bottom-[7px]">
                ...
                <p
                  class="text-gray lg:text-base sm:text-sm text-[11px] hidden lg:block"
                >
                  {{ text.b_title }}
                </p>
              </div>
...
export default {
  ...
  data() {
    return {
      texts: [
        {
          img: "right_section_2.png",
          h2: "Як купити авто, транспорт на Vamberi?",
          title:
            "Как купить авто, б/у и новое, через доску частных объявлений Vamberi?",
          date: "25.04.2022",
          look: "24",
          b_title: "Новини компанії Vamberi • 25 червня 2022",
        },
        {
          img: "right_section_1.png",
          h2: "Каталог оголошень — швидкий зручний пошук",
          title:
            "Каталог свежих объявлений ➔ Как работать с каталогом✔ Советы по составлению✔ Разные типы объявлений✔ Купить недвижимость✔ Продать авто✔ Найти работу✔ Вакансии ✔Отдать даром✔ Обмен✔ Разместить эффективное объявление прямо сейчас★ ",
          date: "25.02.2022",
          look: "92",
          b_title: "Новини компанії Vamberi • 25 лютого 2022",
        },
        {
          img: "right_section_3.png",
          h2: "Чому варто вибрати Вамбері.",
          title:
            "Сайт объявлений Украина ➔ Покупка недвижимости✔ Продажа авто ✔Выгодный обмен ✔Купить машину б.у. ✔Купить мебель ✔Отдать даром вещи✔ Купить питомца✔ Бесплатные объявления✔ Работа✔ Вакансии✔ Онлайн-покупки ★Полезная информация★ Размещайте объявления уже сейчас ☎",
          date: "23.02.2022",
          look: "74",
          b_title: "Новини компанії Vamberi • 23 лютого 2022",
        },
      ],
