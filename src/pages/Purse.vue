        ...
        >
          <div class="xl:w-[80%] w-full">
            <div class="flex gap-x-5">
              <button
                class="w-[200px] bg-white py-2 border border-accent shadow-md shadow-accent rounded-[10px]"
              >
                <p class="text-center text-sm sm:block hidden">
                  Поповнення балансу
                </p>
                <p class="text-xs sm:hidden">Поповнення</p>
              </button>
              <button
                class="w-[200px] bg-white py-2 border border-accent rounded-[10px]"
              >
            ...
            <div class="flex my-5 items-center gap-x-2">
              <p
                class="bg-accent w-5 h-5 sm:text-sm text-xs flex items-center justify-center rounded-full text-white"
              >
                1
              </p>
            ...
            <div class="flex gap-x-2">
              <button
                class="bg-white rounded-[10px] px-2 py-1 border border-accent overflow-hidden"
              >
            ...
            <div
              class="grid w-full md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-x-4 gap-y-3"
            >
              <div
                class="sm:w-[220px] sm:h-[110px] bg-white border text-center py-6 border-accent rounded-[10px]"
              >
                <p class="lg:text-2xl sm:text-base text-sm font-medium">
                  100 грн
                </p>
              ...
              <div
                class="sm:w-[220px] sm:h-[110px] bg-white border text-center py-6 border-accent rounded-[10px] relative"
              >
                <p class="lg:text-2xl sm:text-base text-sm font-medium">
                  1000 грн
                </p>
                ...
                <p
                  class="text-white text-xs bg-green px-[6px] sm:py-0.5 w-fit rounded-[5px] absolute top-0 sm:left-3 right-3"
                >
                  Популярний вибір
                </p>
              </div>
              <div
                class="sm:w-[220px] sm:h-[110px] bg-white border text-center py-8 border-accent rounded-[10px]"
              >
                <p class="lg:text-2xl sm:text-base text-sm font-medium">
                  Довільна сума
                </p>
            ...
            <button
              class="text-white bg-accent rounded-full sm:block mx-auto hidden mt-6 px-4 py-2"
            >
