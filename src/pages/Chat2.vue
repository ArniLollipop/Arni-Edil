<template>
  ...
  <section class = "container mx-auto px-4 pt-4 xl:pt-6 text-main">
    ...
    <div class = "lg:flex lg:space-x-10 mb-4">
      <SofiaVue></SofiaVue>
      <div class = "lg:w-[75%] w-full relative text-main lg:bg-white lg:px-10 lg:py-10 rounded-[10px]">
        <div class = "w-[40%] float-left lg:block hidden">
          ...
          <router-link to="/support">
            <div class="bg-accent w-full py-4 my-10 rounded-[10px] text-white text-center">
              <p class="text-lg">Підтримка VamBeri</p>
              <p class = "text-base"> Будемо раді вам допомогти!</p>
            </div>
          </router-link>
          <router-link to="/chat2">
            <div class = "w-full pl-3 pt-4 pb-2 border-[0.25px] border-gray rounded-[20px] border-opacity-60 mt-6 hover:bg-pink focus:bg-pink">
              <div class = "flex items-center">
                <div class = "w-fit relative">
                  <img src="@/img/anonymus.svg" alt="" class = "sm:h-[50px] sm:w-[50px] h-[40px] w-[40px]">
                ...
                <div class = "ml-2">
                  ...
                  <p>Здравствйте! Да, решили не меня...</p>
                </div>
              </div>
              <p class = "text-sm text-gray">Шкаф кровать трансформер</p>
            </div>
          </router-link>
          <router-link to="/chat2">
            <div class = "w-full pl-3 pt-4 pb-2 border-[0.25px] border-gray rounded-[20px] border-opacity-60 mt-8 hover:bg-pink focus:bg-pink">
              <div class = "flex items-center">
                <div class = "w-fit relative">
                  <img src="@/img/anonymus.svg" alt="" class = "sm:h-[50px] sm:w-[50px] h-[40px] w-[40px]">
                </div>
                <div class = "ml-2">
                  <p class = "text-base font-medium">TVShop</p>
                  <p>Здравствйте! Да, решили не меня...</p>
                </div>
              </div>
              <p class = "text-sm text-gray">Шкаф кровать трансформер</p>
          ...
          <router-link to="/chat2">
            <div class = "w-full pl-3 pt-4 pb-2 border-[0.25px] border-gray rounded-[20px] border-opacity-60 mt-8 hover:bg-pink focus:bg-pink">
              <div class = "flex items-center">
                ...
                <div class = "ml-2">
                  <p class = "text-base font-medium">Семен Петров</p>
                  <p>Здравствйте! Да, решили не меня...</p>
                </div>
              </div>
              <p class = "text-sm text-gray">Шкаф кровать трансформер</p>
            ...
            <div class = "flex items-center">
              ...
              <div class = "ml-2 w-full">
                ...
                <div class = "w-full flex items-center justify-between">
                  <p class = "sm:text-sm text-xs text-gray sm:mt-2">Шкаф кровать трансформер</p>
                  <div class = "sm:flex w-1/4 hidden items-center gap-x-3 justify-center">
