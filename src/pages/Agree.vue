    ...
    >
      <div class="lg:flex gap-x-5 relative">
        ...
        >
          ...
          >
            Купити улюблені товари безпечно, купити безпечно та швидко
          </h1>
          <router-link to="/blog">
        ...
        <div class="lg:w-[85%] w-full lg:pt-2">
          <h1
            class="lg:text-3xl md:text-[20px] sm:text-base text-[14px] font-medium text-center lg:text-start lg:relative absolute top-0 lg:block hidden"
          >
            Купити улюблені товари безпечно, купити безпечно та швидко
          </h1>
          <div class="md:text-sm text-[12px] w-[94%]">
            <p
              class="lg:my-9 md:my-6 sm:my-4 my-2 font-medium lg:text-[28px] md:text-[20px] sm:text-base text-[12px]"
            >
              Купуйте та продавайте товари безпечно!
            </p>
            <p>
              Якщо щось піде не так, то гроші повернуться вам на карту. Це
              допоможе захиститися від шахраїв.
            </p>
            <p class="font-medium">Гарантія повернення</p>
            <p>
              Якщо товар не отримано або він не відповідає опису, гроші буде
              повернено на картку.
            </p>
            <p class="font-medium">Вирішення спорів</p>
            <p>
              Наші Арбітри допоможуть вирішити суперечку з продавцем, якщо він
              виник за особистої передачі товару.
            </p>
            <p class="font-medium">Безпека</p>
            <p>
              Усі грошові перекази безпечні, а дані банківських карток захищені.
            </p>
            <p
              class="lg:mt-9 md:mt-6 sm:mt-4 mt-2 font-medium lg:text-[28px] md:text-[20px] sm:text-base text-[12px]"
            >
              Як купувати за допомогою безпечної угоди?
            </p>
            ...
            <img
              src="@/img/laptop.svg"
              alt=""
              class="w-[80%] lg:my-10 md:my-6 sm:my-4 my-2"
            />
            <p class="font-medium md:my-4 my-2">
              Домовтесь про отримання товару
            </p>
            <p>
              Після оплати товару у вас з'явиться спеціальна сторінка, де ви
              зможете відстежувати процес покупки. Після отримання вами товару
              та огляду його - вам необхідно підтвердити отримання, і тільки
              після цього продавець отримає гроші, а якщо вас, що не влаштує, то
              ви зможете звернутися в арбітраж і запросити повернення грошей.
            </p>
            <div class="flex justify-end">
              <img
                src="@/img/box_person.svg"
                alt=""
                class="w-[80%] lg:my-10 md:my-6 sm:my-4 my-2"
              />
            </div>
            ...
            <img
              src="@/img/agree_chat.svg"
              alt=""
              class="w-[80%] lg:my-10 md:my-6 sm:my-4 my-2"
            />
            <div class="flex justify-center lg:mt-12 mt-6">
              <button class="px-4 py-2 bg-accent rounded-full w-fit">
                <p class="md:text-sm text-[12px] text-white">
                  Подати оголошення
                </p>
              </button>
            </div>
