<template>
  ...
  <section class = "container mx-auto px-4 pt-4 xl:pt-6 text-main">
    <div class = "flex items-center gap-x-1 pb-4 relative lg:my-6 md:my-4 my-1">
      ...
      <p class = "font-normal sm:text-sm text-[11px] lg:block hidden">Налаштування</p>
      ...
      <p class = "font-normal sm:text-sm text-[11px] lg:hidden">Налаштування</p>
    </div>
      ...
      <div class = "lg:w-[75%] w-full relative">
        ...
        <div class = "text-main " v-show="!isMobileMenuOpen"
          ...
          <div class = "md:bg-white md:border-[1px] border-accent rounded-[10px] w-full lg:px-10 sm:px-6 px-2 sm:py-6 py-2">
            ...
            <div class = "sm:flex items-center sm:space-x-5 border-b border-gray border-opacity-60 sm:pb-6 pb-2 sm:mt-6 mt-2">
              <div class = "sm:w-[20%] sm:text-center">
                <p class = "sm:w-[50%] mx-auto block md:text-base sm:text-sm text-xs">Ім’я</p>
              </div>
              <input type="text" class = "bg-pink mt-1 text-xs sm:py-2 py-1 px-4 w-full sm:w-1/2 rounded-[10px] outline-none">
            </div>
            <div class = "sm:flex items-center sm:space-x-5 border-b border-gray border-opacity-60 sm:pb-6 pb-2 sm:mt-6 mt-2">
              <div class = "sm:w-[20%] sm:text-center">
                <p class = "sm:w-[50%] mx-auto block md:text-base sm:text-sm text-xs">Прізвище</p>
              </div>
              <input type="text" class = "bg-pink mt-1 text-xs sm:py-2 py-1 px-4 w-full sm:w-1/2 rounded-[10px] outline-none">
            </div>
            <div class = "xl:flex items-center xl:space-x-5 border-b border-gray border-opacity-60 sm:pb-6 sm:mt-6 pb-2 mt-2 relative">
              <div class = "xl:w-[20%] xl:text-center">
                <p class = " mx-auto block md:text-base sm:text-sm text-xs"> Номер телефону</p>
              </div>
              <input type="text" placeholder="Вкажіть номер телефону, щоб покупці змогли зв'язатися з вами" class = "bg-white lg:block hidden py-2 w-[80%] rounded-[10px] outline-none placeholder:text-gray text-sm">
              <div class = "flex lg:hidden items-center sm:w-1/2 w-2/3">
                <input type="text" class = "bg-pink mt-1 text-xs sm:py-2 py-1 px-4 w-full lg:hidden rounded-[10px] outline-none">
              </div>
              <button class = "absolute sm:bottom-6 bottom-2 right-0">
                <p class = "text-accent lg:text-base sm:text-sm text-xs underline underline-offset-4 decoration-dotted">Змінити</p>
              </button>
            </div>
            <div class = "xl:flex items-center xl:space-x-5 border-b border-gray border-opacity-60 sm:pb-6 sm:mt-6 pb-2 mt-2 relative">
              <div class = "xl:w-[20%] xl:text-center">
                <p class = " mx-auto block md:text-base sm:text-sm text-xs"> E-mail</p>
              </div>
              <input type="text" placeholder="Вкажіть вашу пошту, щоб покупці змогли зв'язатися з вами" class = "bg-white lg:block hidden py-2 w-[80%] rounded-[10px] outline-none placeholder:text-gray lg:text-sm text-xs">
              <div class = "flex items-center w-2/3 lg:hidden relative">
                <label for="text" class = "relative">
                  <input type="text" id="text" class = "peer hidden active:block focus:block outline-none text-xs py-1 mt-1">
                  <p class = "text-gray text-xs z-10 peer-active:hidden peer-focus:hidden cursor-pointer">Вкажіть e-mail та отримайте 20 грн. на свій бонусний рахунок</p>
                </label>
              </div>
              <button class = "absolute sm:bottom-6 bottom-2 right-0">
                <p class = "text-accent lg:text-base sm:text-sm text-xs underline underline-offset-4 decoration-dotted">Змінити</p>
            ...
            <div class = "flex lg:justify-start justify-between items-center sm:space-x-5 border-b border-gray border-opacity-60 sm:pb-6 sm:mt-6 pb-2 mt-2 relative">
              <div class = "sm:w-[20%] sm:text-center">
                <p class = " mx-auto block md:text-base sm:text-sm text-xs"> Пароль</p>
              </div>
              <button class = "">
                <p class = "text-accent lg:text-base sm:text-sm text-xs underline underline-offset-4 decoration-dotted">Змінити</p>
              </button>
            ...
            <div class = "sm:flex items-center sm:space-x-5 border-b border-gray border-opacity-60 sm:pb-6 pb-2 sm:mt-6 mt-2">
              <div class = "sm:w-[20%] sm:text-center">
                <p class = "sm:w-[50%] mx-auto block md:text-base sm:text-sm text-xs">Місто</p>
              </div>
              <input type="text" class = "bg-pink mt-1 text-xs sm:py-2 py-1 px-4 w-full sm:w-1/2 rounded-[10px] outline-none">
            </div>
            <div class = "sm:flex sm:space-x-5 mt-6">
              <div class = "sm:w-[20%] sm:text-center">
          ...
          <div class = "md:bg-white md:border-[1px] border-accent rounded-[10px] w-full md:px-10 sm:px-4 px-2 py-6">
            ...
            <div class = "sm:flex items-center justify-between w-full border-b border-gray border-opacity-60 sm:pb-6 sm:mt-6 pb-2 mt-2 relative">
              <div class = "sm:w-[30%] sm:text-center">
                <p class = "mx-auto block md:text-base sm:text-sm text-xs">Рахунок</p>
              </div>
              <div>
                <button class = "text-accent text-sm sm:text-xs underline decoration-dashed underline-offset-4 sm:relative absolute top-0 right-0">Додати</button>
              </div>
              <div class = "sm:w-[57%] xl:w-[60%] w-full mt-2">
                <p class = "text-gray sm:text-sm text-xs mt-2 sm:mt-0">Додайте рахунок для отримання оплати за безпечною угодою</p>
              </div>
            </div>
            <div class = "sm:flex items-center sm:space-x-5 sm:mt-6 mt-2 relative">
              <div class = "sm:w-[30%] sm:text-center">
                <p class = "mx-auto block md:text-base sm:text-sm text-xs">Сповіщення</p>
              </div>
              <div>
                <button class = "text-accent text-sm sm:text-xs underline decoration-dashed underline-offset-4 sm:relative absolute top-0 right-0">Змінити</button>
              </div>
            </div>
          </div>
          <button class = "bg-accent lg:py-4 sm:py-3 py-2 lg:px-14 sm:px-10 px-6 rounded-full text-sm text-white w-fit block mx-auto md:mt-10 sm:mt-6 mt-4">
            Зберегти
          </button>
        </div>
      </div>
