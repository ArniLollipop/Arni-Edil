<template>
  ...
  <section class="2xl:w-[1400px] 2xl:mx-auto mx-auto px-4 py-4 text-dark">
    <div
      class="flex items-center justify-between gap-x-1 mb-4 relative lg:my-6 md:my-4 my-1"
    >
        ...
        <div class="lg:w-[80%] lg:pr-9 w-full">
          <div class="relative">
            <h2 class="font-medium lg:text-[26px] sm:text-xl text-[13px]">
              Як купити авто, транспорт на Vamberi?
            </h2>
            <h2 class="font-medium lg:text-[26px] sm:text-xl text-[13px] mt-8">
              Купівля авто на Vamberi
            </h2>
            <p
              class="sm:mt-3 lg:mt-4 mt-2 lg:mb-9 md:mb-6 sm:mb-4 mb-2 sm:text-base text-[12px]"
            >
              Автомобіль - це засіб пересування, який може прослужити не один
              рік і не одному господареві. До купівлі особистого транспортного
              засобу варто підходити відповідально та ґрунтовно. Купити авто б/в
              чи нове в Україні можна на багатьох автобазарах, салонах і навіть
            ...
            <ol type="1" class="sm:my-4 lg:my-6 my-2 sm:text-base text-[12px]">
              ...
              <li class="md:my-3 my-1">
                1. Визначтеся, навіщо вам потрібна машина і скільки ви готові за
                неї заплатити.
              </li>
              <li class="md:my-3 my-1">2. Знайдіть сумлінного продавця.</li>
              <li class="md:my-3 my-1">
                3. Ретельно вивчіть середню вартість ринку, пробіг і фотографії.
              </li>
              <li class="md:my-3 my-1">
            ...
            <p
              class="sm:mt-3 lg:mt-4 mt-2 lg:mb-9 md:mb-6 sm:mb-4 mb-2 sm:text-base text-[12px]"
            >
              Інтернет-майданчик Vamberi — найкраще місце для пошуку нового або
              старого транспортного засобу. На нашому сайті ви можете швидко і
              недорого купити машину б/у або підібрати для себе автомобіль із
              салону.
            </p>
            <p
              class="sm:mt-3 lg:mt-4 mt-2 lg:mb-9 md:mb-6 sm:mb-4 mb-2 sm:text-base text-[12px]"
...
>>>>>>> c9e056ff35523e652c9102fc34b44f008bc597b6
            ...
            <p
              class="sm:mt-3 lg:mt-4 mt-2 lg:mb-9 md:mb-6 sm:mb-4 mb-2 sm:text-base text-[12px]"
            >
              Користувач може самостійно відфільтрувати товар, що його цікавить.
              Залежно від часу розміщення публікації нагорі дошки з'являються
              машини, які тільки-но вийшли з конвеєра або шукають нового
              власника. Підписка на повідомлення дасть можливість першим
              дізнаватися про нові пропозиції. Інтернет-майданчик діє на
              території всієї України. Купити уживані авто на нашому сайті —
              легко та безпечно. Оператори онлайн-підтримки дадуть відповідь на
              питання, що вас цікавлять.
            </p>
            <h2
              class="font-medium lg:text-[26px] sm:text-xl text-[13px] mt-8 hidden md:block"
            >
              Чому варто розмістити оголошення про продаж машини на Vamberi.
            </h2>
            <p
              class="sm:mt-3 lg:mt-4 mt-2 lg:mb-9 md:mb-6 sm:mb-4 mb-2 sm:text-base text-[12px] hidden md:block"
            >
              Сайт оголошень Vamberi пропонує здійснити угоду про продаж на
              взаємовигідних умовах. Функція безпечної угоди захистить від
              недоброзичливців. Розмістивши на дошці оголошення про продаж, ви
              швидко знайдете потенційного покупця.
            </p>
            <p
              class="sm:mt-3 lg:mt-4 mt-2 lg:mb-9 md:mb-6 sm:mb-4 mb-2 sm:text-base text-[12px] hidden md:block"
            >
              Легкий функціонал сайту дозволяє легко подати оголошення. Для
              цього випливає:
            </p>
            <ul class="hidden mmd:block">
              <li
                class="md:mt-3 md:text-sm text-[12px] my-1 md:ml-3 ml-2 relative before:absolute before:md:top-3 before:top-2 before:md:-left-3 before:-left-[6px] before:w-1 before:h-1 before:bg-dark before:rounded-full"
              >
                зареєструватися або пройти авторизацію за допомогою Фейсбуку;
              </li>
              <li
                class="md:mt-3 md:text-sm text-[12px] my-1 md:ml-3 ml-2 relative before:absolute before:md:top-3 before:top-2 before:md:-left-3 before:-left-[6px] before:w-1 before:h-1 before:bg-dark before:rounded-full"
              >
                налаштувати особистий профіль;
              </li>
              <li
                class="md:mt-3 md:text-sm text-[12px] my-1 md:ml-3 ml-2 relative before:absolute before:md:top-3 before:top-2 before:md:-left-3 before:-left-[6px] before:w-1 before:h-1 before:bg-dark before:rounded-full"
              >
                подати оголошення, натиснувши кнопку в правому верхньому кутку;
              </li>
              <li
                class="md:mt-3 md:text-sm text-[12px] my-1 md:ml-3 ml-2 relative before:absolute before:md:top-3 before:top-2 before:md:-left-3 before:-left-[6px] before:w-1 before:h-1 before:bg-dark before:rounded-full"
              >
                вибрати розділ «Авто» та підкатегорію;
              </li>
              <li
                class="md:mt-3 md:text-sm text-[12px] my-1 md:ml-3 ml-2 relative before:absolute before:md:top-3 before:top-2 before:md:-left-3 before:-left-[6px] before:w-1 before:h-1 before:bg-dark before:rounded-full"
              >
                заповнити інформацію про товар.
              </li>
            </ul>
            <p
              class="sm:mt-3 lg:mt-4 mt-2 lg:mb-9 md:mb-6 sm:mb-4 mb-2 sm:text-base text-[12px] hidden md:block"
            >
              З Vamberi продаж машин та їх придбання стануть легким заняттям. Це
              правильний спосіб не тільки купити авто дешево, та й продати його
              за вигідною ціною.
            </p>
            <button
            ...
            <div
              class="w-full bg-pink px-2 py-2 relative flex my-6 rounded-[10px]"
            >
              <input
                type="text"
